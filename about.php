		...
		<div class="container">
			...
			<div class="about-agileinfo w3layouts">
				<div class="col-md-8 about-wthree-grids grid-top">
					<h4>Warung Mang Ujang adalah salah satu proyek toko online berbasis Web yang menjual atribut tempur yang akan membuat para pembeli merasa gagah</h4>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Perumahan Jatijaja A23/15, <span>Kota Depok.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:rezaagung2205@gmail.com">rezaagung2205@gmail.com</a></li>
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="kategori.php">Baju Anti Malu</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Profile</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="checkout.php">Keranjang Saya</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="logout.php">Mau Keluar?</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
