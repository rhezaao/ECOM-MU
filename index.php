...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/maguire-home.jpeg" alt="" />
			</li>
			<li>
				<img src="images/fred-away.jpeg" alt="" />
			</li>
			
			<li>
				<img src="images/elanga-third.jpeg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								<h5>Beli Lah Cepat Selagi Murah
								<?php
								if(!isset($_SESSION['name'])){
									
								} else {
									echo 'Ngab '.$_SESSION['name'].'!';
								}
								?>
								</h5>
								</div>
